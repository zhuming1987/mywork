...
public class DVBSLNBTypeListDialog extends TvBaseDialog{

	private DVBSLNBTypeListView DVBSLNBTypeListView;
	private DialogListener dialogListener;
	public DVBSLNBTypeListDialog() {
		super(TvContext.context, R.style.dialog,TvConfigTypes.TV_DIALOG_DVBS_LNBTYPE_LIST);
		// TODO Auto-generated constructor stub
		DVBSLNBTypeListView = new DVBSLNBTypeListView(TvContext.context,this);
		setDialogAttributes(Gravity.LEFT | Gravity.TOP, 
				WindowManager.LayoutParams.TYPE_SYSTEM_ALERT);
		setDialogContentView(DVBSLNBTypeListView);
	...
	public boolean processCmd(String key, DialogCmd cmd, Object obj) {
		// TODO Auto-generated method stub
		if(!key.equals(TvConfigTypes.TV_DIALOG_DVBS_LNBTYPE_LIST)) return false;
		switch (cmd) {
		case DIALOG_SHOW:
		case DIALOG_UPDATE:
			super.showUI();
			DVBSLNBTypeListView.updateView();
			break;
		case DIALOG_HIDE:
			break;
		case DIALOG_DISMISS:
