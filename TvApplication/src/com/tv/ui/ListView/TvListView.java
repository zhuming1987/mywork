...
public class TvListView extends LinearLayout implements onKeyDownListener{
    ...
    protected ArrayList<TvListItemView> viewList = new ArrayList<TvListItemView>();
	...
	public void updateView(MenuItem data)
	{
		...
		{
			TvListItemView view = new TvListItemView(mContext, this, i);
