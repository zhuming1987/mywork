...
import com.tv.ui.ListView.TvListItemView.onKeyDownListener;
...
public class TvLNBListView extends LinearLayout implements onKeyDownListener, com.tv.ui.LNBSetting.TvLNBListItemView.onKeyDownListener{
    ...
    private TvListViewDialog parentDialog = null;
    ...
    public LNBSettingView lnbSettingView;
    private ArrayList<String> dataList = new ArrayList<String>();
    protected ArrayList<TvLNBListItemView> viewList = new ArrayList<TvLNBListItemView>();
    protected MenuItem data;
    
	public TvLNBListView(Context context,LNBSettingView lnbSettingView) {
		super(context);
		// TODO Auto-generated constructor stub
		this.lnbSettingView=lnbSettingView;
		...
		this.addView(titleLayout,new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, (int) (0 / div)));
		
		bodyLayout = new LeftViewBodyLayout(context);
		bodyLayout.setOrientation(LinearLayout.VERTICAL);
		bodyLayout.setBackgroundColor(Color.rgb(00,00,00));
		this.addView(bodyLayout,new LinearLayout.LayoutParams(LayoutParams.MATCH_PARENT, (int) (600 / div)));
...
//        bodyLayout.addView(scrollView);
        bodyLayout.addView(scrollView,new LayoutParams(LayoutParams.MATCH_PARENT,LayoutParams.WRAP_CONTENT));
        ...
        itemParams.bottomMargin = (int) (0 / div);
	...
	public void updateView(MenuItem data)
	{
		...
		{
			TvLNBListItemView view = new TvLNBListItemView(mContext, this, i,lnbSettingView);
	...
	public void setParentDialog(TvListViewDialog parentDialog) {
	...
	public void ItemClickListener(int index) {
		...
		for(TvLNBListItemView view : viewList)
		{
			if(view.index == index)
				continue;
		...
		lnbSettingView.ScanCurrentFreq();
	}
	
	public ArrayList<TvLNBListItemView> getViewList() {
		return viewList;
	}
