...
public class MotorSettingEnterItemView extends LinearLayout implements View.OnKeyListener, View.OnFocusChangeListener{
	...
	public MotorSettingEnterItemView(Context context) {
		super(context);
        ...
        contextParams.gravity = Gravity.CENTER_VERTICAL;
